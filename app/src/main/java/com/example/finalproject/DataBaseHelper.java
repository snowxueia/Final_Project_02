...
//        return checkDB != null ? true : false;
    ...
    public String[][] getAppCategoryDetail(String table_name, int row, int col) {
...
/*    // Add your public helper methods to access and get content from the database.
    ...
    public boolean insertInReview(String word, String def) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValue = new ContentValues();
        contentValue.put("word", word);
        contentValue.put("def", def);
        long result = db.insert("review", null, contentValue);
    ...
    public int getReviewRowNum() {
        String table_name = "review";
        String selectQuery = "SELECT  * FROM " + table_name;
        SQLiteDatabase db  = this.getReadableDatabase();
//        long count = DatabaseUtils.queryNumEntries(db, "review");
        Cursor cursor = db.rawQuery(selectQuery, null);
